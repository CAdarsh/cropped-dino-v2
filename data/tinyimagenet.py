...
class TinyImageNet(VisionDataset):
    """`tiny-imageNet <http://cs231n.stanford.edu/tiny-imagenet-200.zip>`_ Dataset.
        ...
        Source: https://github.com/lvyilin/pytorch-fgvc-dataset/blob/master/tiny_imagenet.py 
    """
    ...
    def __init__(self, root, split='train', transform=None, target_transform=None, download=False):
        ...
        if os.path.exists(os.path.join(root, self.base_folder)):
...
if __name__ == '__main__':
    train_dataset = TinyImageNet(
        './tiny-imagenet', split='train', download=True)
